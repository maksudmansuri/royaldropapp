...
class Product(models.Model):
    ...
    product_selling_price   =           models.FloatField(default=0.0,null=True)
    discount_percentage   =           models.DecimalField(default=0.0,null=True,decimal_places=2,max_digits=10,blank=True)
