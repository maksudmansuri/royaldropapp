# Generated by Django 3.2.4 on 2021-07-20 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GST_in_percentage', models.CharField(blank=True, choices=[(1, '0%'), (2, '3%'), (3, '5%'), (4, '12%'), (5, '18%'), (6, '28%')], default='', max_length=16, null=True)),
                ('is_active', models.IntegerField(default=1)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='front.product')),
