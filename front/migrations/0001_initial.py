# Generated by Django 3.2.4 on 2021-07-22 12:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('gst_in_percentage', models.CharField(choices=[(1, '0'), (2, '3'), (3, '5'), (4, '12'), (5, '18'), (6, '28')], default='', max_length=255)),
                ('hsn_nunber', models.CharField(default='', max_length=256, null=True)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='front.product')),
            ],
