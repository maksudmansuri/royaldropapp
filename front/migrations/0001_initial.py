# Generated by Django 3.2.4 on 2021-08-11 13:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('Ordes_id', models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='front.customersorders')),
                ('product', models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='front.product')),
            ],
            options={
                'ordering': ['-updated_at'],
            },
