...
urlpatterns = [
    ...
    path('student_browse_products', views.student_browse_products,name='student_browse_products'),
    ...
    path('student_my_products', views.student_my_products,name='student_my_products'),
    ...
    path('student_take_product/<slug:slug>', views.student_take_product,name='student_take_product'),
    path('student_take_product_session/<product_slug>/<slug>/<sslug>', views.student_take_product_session,name='student_take_product_session'),
    path('student_take_quiz', views.student_take_quiz,name='student_take_quiz'),
    path('student_view_product', views.student_view_product,name='student_view_product'),
