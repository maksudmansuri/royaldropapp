...
from accounts.models import CustomUser,AdminHOD,Staffs,Customers
from front.models import Product,Product_Modules,Product_Session,ProductCategory,ProductSubCategory,viewed
from front.api.serializers import ProductDatailSerializer,ProductDetailUpdateSerializer,ProductDetailCreateSerializer
...
def api_create_product_view(request):
	...
	if request.method == 'POST':
		...
		data['product_subcategory'] = ProductSubCategory.objects.get(id=2).pk
		print(data)
