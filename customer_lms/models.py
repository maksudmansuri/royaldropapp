...
from accounts.models import Customers as Customers
...
#     customer_phone=models.CharField(max_length=50,default=0,null=True)
#     customer_email=models.EmailField(max_length=254,default="",null=True)
#     objects = models.Manager()
